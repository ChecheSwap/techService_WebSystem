    ...
    <div class="row justify-content-center">
        ...
        <div class="col-auto mb-3">
            <div class="card bg-light" style="width: 300px;">
                <img class="img-responsive bg-primary2" src="../../images/addxc.png" alt="Card image" style="max-width:300px; height: 280px;">
                <div class="card-body bg-gray">
                    <p class="card-text">Orden de Servicio</p>
                    <a href="registro_orden.php" class="btn btn-info btn-block">*Crear orden de Servicio.</a>
                </div>
            </div>
        </div>
