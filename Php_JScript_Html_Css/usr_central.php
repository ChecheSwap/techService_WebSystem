    ...
    <div class="row justify-content-center">
        ...
        <div class="col-auto mb-3">
            <div class="card bg-light" style="width: 300px;">
                <img class="img-responsive bg-primary2" src="../../images/xusradd.png" alt="Card image" style="max-width:300px; height:280px;">
                <div class="card-body bg-gray">
                    <p class="card-text">Registro de Cliente con generacion de cuenta de usuario.</p>
                    <a href="usr_alta.php" class="btn btn-info btn-block">*Registrar Cliente</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-auto mb-3">
            <div class="card bg-light" style="width: 300px;">
                <img class="img-responsive bg-primary2" src="../../images/user_edit.png" alt="Card image" style="max-width:300px; height:280px;">
                <div class="card-body bg-gray">
                    <p class="card-text">Actualizar datos de Usuario.</p>
                    <br>
                    <a href="usr_update.php" class="btn btn-info btn-block">*Actualizar Datos</a>
                </div>
            </div>
        </div>
