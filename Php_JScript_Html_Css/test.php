...
require_once("LOGIC/test_php.php");
?>
...
<div align="center">
    <a class="btn btn-warning" id="btnok" name="btnok" onclick="myfunc()">TEST POST</a>

    <p id="ok"><?php echo $main?></p>
</div>
...
<script>
    function myfunc() {
        ...
        xhttp.open("POST", "LOGIC/test_php.php", true);
        xhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        xhttp.send("action=test");
    }
</script>
